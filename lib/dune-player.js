...
class DunePlayer {
  ...
  /** @returns {Promise<object>} */ async power() {
    return this.pressButton("POWER");
  }
  /** @returns {Promise<object>} */ async up() {
    return this.pressButton("UP");
  }
  /** @returns {Promise<object>} */ async down() {
    return this.pressButton("DOWN");
  }
  /** @returns {Promise<object>} */ async left() {
    return this.pressButton("LEFT");
  }
  /** @returns {Promise<object>} */ async right() {
    return this.pressButton("RIGHT");
  }
  /** @returns {Promise<object>} */ async ok() {
    return this.pressButton("ENTER");
  }
  /** @returns {Promise<object>} */ async back() {
    return this.pressButton("RETURN");
  }
  /** @returns {Promise<object>} */ async menu() {
    return this.pressButton("TOP_MENU");
  }
  /** @returns {Promise<object>} */ async popupMenu() {
    return this.pressButton("POP_UP_MENU");
  }
  /** @returns {Promise<object>} */ async mute() {
    return this.pressButton("MUTE");
  }
  /** @returns {Promise<object>} */ async audio() {
    return this.pressButton("AUDIO");
  }
  /** @returns {Promise<object>} */ async subtitle() {
    return this.pressButton("SUBTITLE");
  }
  /** @returns {Promise<object>} */ async volumeUp() {
    return this.pressButton("V_UP");
  }
  /** @returns {Promise<object>} */ async volumeDown() {
  ...
  /** @returns {Promise<object>} */ async play() {
    return this.setPlaybackState({ speed: 256 });
  }
  /** @returns {Promise<object>} */ async pause() {
    return this.setPlaybackState({ speed: 0 });
  }
  /** @returns {Promise<object>} */ async stop() {
    return this.playbackAction("stop");
  }
  /** @returns {Promise<object>} */ async rewind() {
    return this.setPlaybackState({ speed: -512 });
  }
  /** @returns {Promise<object>} */ async forward() {
    return this.setPlaybackState({ speed: 512 });
  }
  ...
  /** @returns {Promise<object>} */ async pausePlayback() {
    return this.setPlaybackState({ speed: 0 });
  }
  /** @returns {Promise<object>} */ async resumePlayback() {
    return this.setPlaybackState({ speed: 256 });
  }
  ...
  /** @returns {Promise<object>} */ async mainScreen() {
    return this.sendCommand("main_screen");
  }
  /** @returns {Promise<object>} */ async blackScreen() {
    return this.sendCommand("black_screen");
  }
  /** @returns {Promise<object>} */ async standby() {
  ...
  /** @returns {Promise<object>} */ async openApplications() {
    return this.openPath("root://applications");
  }
  /** @returns {Promise<object>} */ async openSetup() {
    return this.openPath("root://setup");
  }
  /** @returns {Promise<object>} */ async openFavorites() {
    return this.openPath("root://favorites");
  }
  /** @returns {Promise<object>} */ async openSources() {
